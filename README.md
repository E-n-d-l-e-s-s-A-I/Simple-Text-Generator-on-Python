...
Приложение полностью написано с использованием стандартных библиотек Python, включая tkinter для создания графического интерфейса. Это означает, что установка дополнительных зависимостей не требуется.
...
<div style="text-align: center;">
  <img src="https://i.postimg.cc/fLxMbbWV/Text-Generator-Class-Diagramm.png)](https://postimg.cc/bDN7CptP" alt="Description of the image" />
</div>
